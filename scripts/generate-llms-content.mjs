...
function buildLlmsFull(essays) {
  const header = [
    ...
    '## Position',
    '',
    'Software is beginning to act across systems built for people. Agency now moves through data, markets, institutions, infrastructure, commerce, and the physical world.',
    '',
    '## Canonical Pages',
    '',
