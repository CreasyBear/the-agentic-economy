...
|------|----------|-----------|
| 2026-03-18 | Pivot from "Academic Journal" to "Tectonic Shift" | The subject matter requires a design that feels tangible and structural. The old design was "the mean"; the new design reflects a world moving beneath our feet. |
| 2026-03-18 | Adopt Safety Orange (`#FF4500`) as primary accent | Replaces generic cyan to evoke construction, warning, and heavy machinery. |
| 2026-03-18 | Remove all border-radius | Reinforces the brutal, structural, "cut from stone" aesthetic. |
